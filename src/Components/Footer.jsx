...
<footer class="bg-neutral-primary-soft">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 text-white">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="/logo.png" class="h-7 me-3" alt="FlowBite Logo" />
                  <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap">Apps Hero</span>
              </a>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <span class="text-sm text-body sm:text-center">© {year}  <a href="/" class="hover:underline">Apps Hero</a>. All Rights Reserved.
          </span>
